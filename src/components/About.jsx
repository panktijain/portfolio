    ...
    <section id="about" className="py-20 relative bg-white dark:bg-dark-bg">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-12 items-center">
          <AnimatedSection className="md:w-1/3 relative" delay={0.1}>
          ...
          <AnimatedSection className="md:w-2/3 text-lg text-slate-600 dark:text-slate-300 space-y-4" delay={0.2}>
             <p>
